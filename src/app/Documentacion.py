...
def get_pasos_pseudocodigo():
    ...
    pasos_programa_path = (pathlib.Path(__file__).parent.parent.parent / "docs" / "pasos_programa.md").resolve()
...
def get_ejecucion_programa():
    ...
    ejecucion_programa_path = (pathlib.Path(__file__).parent.parent.parent / "docs" / "Ejecucion_programa.md").resolve()
...
def render_diagrama():
    ...
    """
    diagrama_path = (pathlib.Path(__file__).parent.parent.parent / "docs" / "diagrama.md").resolve()
...
def documentacion():
    ...
    readme_path = (pathlib.Path(__file__).parent.parent.parent / "README.md").resolve()
